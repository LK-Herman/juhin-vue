...
namespace JuhinAPI.Migrations
{
    public partial class SetVendors : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"
                delete [dbo].[Vendors] where [Id] = '445f2b47-d04f-4956-e8ed-08d989b7e659'
                delete [dbo].[Vendors] where [Id] = '62dddc26-d0d8-43ed-e8ee-08d989b7e659'
                delete [dbo].[Vendors] where [Id] = 'f8dddc24-d0d8-43ed-e8ee-08d989b7e65a'
                delete [dbo].[Vendors] where [Id] = '6eaf2b47-a048-6956-28e2-01d981b7e688'
                delete [dbo].[Vendors] where [Id] = '1e5f2b47-d041-4956-e8e1-08d981b7e652'
